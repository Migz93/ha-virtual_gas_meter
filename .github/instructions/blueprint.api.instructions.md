...
- `VirtualGasMeterApiClientError` (Base)
- `VirtualGasMeterApiClientCommunicationError` (Network, timeout, HTTP errors)
- `VirtualGasMeterApiClientAuthenticationError` (401, 403, invalid credentials)
