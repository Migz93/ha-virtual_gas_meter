...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `VirtualGasMeter`
...
- Inherit from both platform entity and `VirtualGasMeterEntity` (order matters)
...
from custom_components.virtual_gas_meter.sensor import async_setup_entry
...
**Config entry data:** `entry_data: VirtualGasMeterData = hass.data[DOMAIN][entry.entry_id]`
