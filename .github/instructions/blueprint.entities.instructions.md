...
- **`entity/`** - Base entity classes (inherit `VirtualGasMeterEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, VirtualGasMeterEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import VirtualGasMeterEntity`
