...
- `entity/` — Base entity class (`VirtualGasMeterEntity`)
...
- Entity MRO: `(PlatformEntity, VirtualGasMeterEntity)` — order matters
...
- Debug level: `custom_components.virtual_gas_meter: debug` in `config/configuration.yaml`
