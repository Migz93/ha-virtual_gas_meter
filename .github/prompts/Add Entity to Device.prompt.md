...
- Inherit from `VirtualGasMeterEntity` and platform base class
...
- Entity: `custom_components/virtual_gas_meter/[platform]/[entity_name].py`
- Platform: `custom_components/virtual_gas_meter/[platform]/__init__.py`
