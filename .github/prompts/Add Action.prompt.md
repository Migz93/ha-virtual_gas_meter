...
**File:** `custom_components/virtual_gas_meter/services.yaml`
...
Create `custom_components/virtual_gas_meter/service_actions/[action_name].py`:

```python
"""[Action name] service action for Virtual Gas Meter."""
...
**File:** `custom_components/virtual_gas_meter/__init__.py`
...
**File:** `custom_components/virtual_gas_meter/const.py`
...
3. Find service action: `virtual_gas_meter.[action_name]`
...
- **Service actions directory:** `custom_components/virtual_gas_meter/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/virtual_gas_meter/services.yaml` (legacy filename)
- **Icons:** `custom_components/virtual_gas_meter/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/virtual_gas_meter/translations/*.json` under `services` key (legacy)
