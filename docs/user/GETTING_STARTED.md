# Getting Started with Virtual Gas Meter

This guide will help you install and set up the Virtual Gas Meter custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/Migz93/ha-virtual_gas_meter`
6. Set category to "Integration"
7. Click "Add"
8. Find "Virtual Gas Meter" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/Migz93/ha-virtual_gas_meter/releases)
2. Extract the `virtual_gas_meter` folder from the archive
3. Copy it to `custom_components/virtual_gas_meter/` in your Home Assistant configuration directory
...
3. Search for "Virtual Gas Meter"
...
4. Select entities from "Virtual Gas Meter"
...
- Report issues at [GitHub Issues](https://github.com/Migz93/ha-virtual_gas_meter/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/Migz93/ha-virtual_gas_meter/discussions)
